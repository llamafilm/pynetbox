...
class Record:
    ...
    def full_details(self):
        ...
        """
        if self.url:
            # Construct URL preserving the API's host:port configuration
            api_parsed = urlparse(self.api.base_url)
            record_parsed = urlparse(self.url)
            corrected_url = record_parsed._replace(
